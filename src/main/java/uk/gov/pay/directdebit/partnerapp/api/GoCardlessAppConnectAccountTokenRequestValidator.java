...
public class GoCardlessAppConnectAccountTokenRequestValidator extends ApiValidation {
    private static final String[] requiredFields = new String[]{CODE_FIELD, STATE_FIELD};
    ...
    static {
        ...
        validators.put(STATE_FIELD, ApiValidation::isNotNullOrEmpty);
        
        fieldSizes.put(CODE_FIELD, new FieldSize(1, 255));
        fieldSizes.put(STATE_FIELD, new FieldSize(26, 26));
    }
