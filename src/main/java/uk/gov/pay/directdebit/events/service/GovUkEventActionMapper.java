...
public class GovUkEventActionMapper implements EventActionMapper {

    private static final Logger LOGGER = LoggerFactory.getLogger(GovUkEventActionMapper.class);
