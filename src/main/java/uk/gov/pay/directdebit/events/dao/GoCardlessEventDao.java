...
public interface GoCardlessEventDao {
    ...
    @SqlUpdate("INSERT INTO gocardless_events(gocardless_event_id, action, resource_type, json, created_at,  details_reason_code, details_scheme, mandate_id, customer_id, "
