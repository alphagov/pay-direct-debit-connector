...
public class GatewayAccountResourceIT {
    ...
    public void shouldReturnAGatewayAccountIfItExists() {
        ...
        givenSetup()
                ...
                .contentType(JSON)
                .body(PAYMENT_PROVIDER_KEY, is(PAYMENT_PROVIDER))
    ...
    public void shouldReturnAllGatewayAccounts() {
        ...
        givenSetup()
                ...
                .body(format("accounts[0].%s", PAYMENT_PROVIDER_KEY), is(PAYMENT_PROVIDER))
                ...
                .body(format("accounts[1].%s", PAYMENT_PROVIDER_KEY), is(paymentProvider2))
